                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          width: width*0.7,
                          child: Text(
                            '${AllTexts.codeSend} ${AllTexts.emailAddress}',
                            style: AllTextStyles.onboardDesStyle,
                            textAlign: TextAlign.center
                          ),
                        ),
                        const SizedBox(height: 20),
                        PinValidator(digitOne: digitOne, digitTwo: digitTwo, digitThree: digitThree, digitFour: digitFour),
                        Spacer(),
                        ElevatedButtonDesign(title: AllTexts.verify),
